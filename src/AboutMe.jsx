...
{/* <img src={require('./img/me.jpg')}></img> */}
   <a  href="https://drive.google.com/file/d/1fflGyUgb7zLSEktYL4q2c1uzFo00DgHa/view?usp=sharing" target="_blank"  rel="noopener noreferrer"> <button className="BtnCV" >Descarga mi cv</button></a>
     </div> 
     </div>
     </Zoom>
    )
